...
public abstract class LancheDecorator extends ItemCardapio {
    ...
    public LancheDecorator(ItemCardapio itemDecorado) {
        ...
        if (!(itemDecorado instanceof Lanche) && !(itemDecorado instanceof LancheDecorator)) {
            throw new IllegalArgumentException("ERR07 - Somente lanches podem receber itens adicionais!");
        }
    ...
    public void setDescricao(String descricao) {
        throw new UnsupportedOperationException("ERR07 - A descrição de um item decorado é derivada automaticamente," +
